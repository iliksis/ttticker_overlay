...
{:else if overlayState === 'overview'}
	{#if data}
		<div
			class="absolute top-0 right-0 bottom-0 left-0 m-auto h-fit w-5xl items-start justify-center rounded-md bg-linear-to-br from-player/80 to-match/80 p-4 text-white"
		>
			<!-- Team Header -->
